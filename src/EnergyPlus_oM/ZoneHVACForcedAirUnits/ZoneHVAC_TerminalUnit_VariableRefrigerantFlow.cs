...
namespace BH.oM.Adapters.EnergyPlus.ZoneHVACForcedAirUnits
{
    ...
    public class ZoneHVAC_TerminalUnit_VariableRefrigerantFlow : BHoMObject
    {
        ...
        public EmptyNoYes SupplyAirFanObjectType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Fan:ConstantVolume");
        ...
        public EmptyNoYes OutsideAirMixerObjectType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
