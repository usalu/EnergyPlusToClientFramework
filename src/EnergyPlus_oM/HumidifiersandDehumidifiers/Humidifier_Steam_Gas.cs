...
namespace BH.oM.Adapters.EnergyPlus.HumidifiersandDehumidifiers
{
    ...
    public class Humidifier_Steam_Gas : BHoMObject
    {
        ...
        public EmptyNoYes InletWaterTemperatureOption { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "FixedInletWaterTemperature");
    }
}