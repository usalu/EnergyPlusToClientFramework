...
namespace BH.oM.Adapters.EnergyPlus.ThermalZonesandSurfaces
{
    ...
    public class WindowShadingControl : BHoMObject
    {
        ...
        public EmptyNoYes ShadingType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
        ...
        public EmptyNoYes ShadingControlType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
        ...
        public EmptyNoYes TypeOfSlatAngleControlForBlinds { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "FixedSlatAngle");
        ...
        public EmptyNoYes MultipleSurfaceControlType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Sequential");
