...
namespace BH.oM.Adapters.EnergyPlus.ThermalZonesandSurfaces
{
    ...
    public class Zone : BHoMObject
    {
        ...
        public EmptyNoYes ZoneInsideConvectionAlgorithm { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
        ...
        public EmptyNoYes ZoneOutsideConvectionAlgorithm { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
