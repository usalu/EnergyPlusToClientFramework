...
namespace BH.oM.Adapters.EnergyPlus.Economics
{
    ...
    public class UtilityCost_Ratchet : BHoMObject
    {
        ...
        public EmptyNoYes SeasonFrom { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
        ...
        public EmptyNoYes SeasonTo { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
