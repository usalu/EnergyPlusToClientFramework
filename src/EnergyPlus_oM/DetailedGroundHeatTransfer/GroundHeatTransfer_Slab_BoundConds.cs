...
namespace BH.oM.Adapters.EnergyPlus.DetailedGroundHeatTransfer
{
    ...
    public class GroundHeatTransfer_Slab_BoundConds : BHoMObject
    {
        ...
        public EmptyNoYes EvtrIsSurfaceEvapotranspirationModeled { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
        ...
        public EmptyNoYes FixbcIsTheLowerBoundaryAtAFixedTemperature { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
        ...
        public EmptyNoYes UsrhflagIsTheGroundSurfaceHSpecifiedByTheUser { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
