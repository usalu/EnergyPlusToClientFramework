...
namespace BH.oM.Adapters.EnergyPlus.ZoneHVACRadiativeConvectiveUnits
{
    ...
    public class ZoneHVAC_CoolingPanel_RadiantConvective_Water : BHoMObject
    {
        ...
        public EmptyNoYes ControlType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "MeanAirTemperature");
