namespace BH.oM.Adapters.EnergyPlus.PlantHeatingandCoolingEquipment
{
    ...
    public class Boiler_HotWater : BHoMObject
    {
...
public EmptyNoYes EfficiencyCurveTemperatureEvaluationVariable { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Empty");
...
public EmptyNoYes BoilerFlowMode { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "NotModulated");
