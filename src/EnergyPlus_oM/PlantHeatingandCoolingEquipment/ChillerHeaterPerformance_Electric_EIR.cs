...
namespace BH.oM.Adapters.EnergyPlus.PlantHeatingandCoolingEquipment
{
    ...
    public class ChillerHeaterPerformance_Electric_EIR : BHoMObject
    {
        ...
        public EmptyNoYes ChilledWaterFlowModeType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "ConstantFlow");
        ...
        public EmptyNoYes CoolingModeTemperatureCurveCondenserWaterIndependentVariable { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "EnteringCondenser");
        ...
        public EmptyNoYes HeatingModeTemperatureCurveCondenserWaterIndependentVariable { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "LeavingCondenser");
