...
public EmptyNoYes RoomAirModelingType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Mixing");
        

[JsonProperty("air_temperature_coupling_strategy")]
public EmptyNoYes AirTemperatureCouplingStrategy { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Direct");
    }
}
