...
namespace BH.oM.Adapters.EnergyPlus.SurfaceConstructionElements
{
    ...
    public class Construction_ComplexFenestrationState : BHoMObject
    {
        

        [JsonProperty("basis_type")]
        public EmptyNoYes BasisType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "LBNLWINDOW");
        

        [JsonProperty("basis_symmetry_type")]
        public EmptyNoYes BasisSymmetryType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "None");
