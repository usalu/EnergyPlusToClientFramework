...
namespace BH.oM.Adapters.EnergyPlus.Fans
{
    ...
    public class Fan_VariableVolume : BHoMObject
    {
        ...
        public EmptyNoYes FanPowerMinimumFlowRateInputMethod { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Fraction");
