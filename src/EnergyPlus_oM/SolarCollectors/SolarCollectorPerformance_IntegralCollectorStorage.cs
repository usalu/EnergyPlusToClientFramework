...
namespace BH.oM.Adapters.EnergyPlus.SolarCollectors
{
    ...
    public class SolarCollectorPerformance_IntegralCollectorStorage : BHoMObject
    {
        

        [Description("Currently only RectangularTank ICS collector type is available.")]
        [JsonProperty("ics_collector_type")]
        public EmptyNoYes IcsCollectorType { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "RectangularTank");
