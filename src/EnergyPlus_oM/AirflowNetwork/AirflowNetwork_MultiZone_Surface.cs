...
namespace BH.oM.Adapters.EnergyPlus.AirflowNetwork
{
    ...
    public class AirflowNetwork_MultiZone_Surface : BHoMObject
    {
        ...
        public EmptyNoYes VentilationControlMode { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "ZoneLevel");
        ...
        public EmptyNoYes EquivalentRectangleMethod { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "PolygonHeight");
