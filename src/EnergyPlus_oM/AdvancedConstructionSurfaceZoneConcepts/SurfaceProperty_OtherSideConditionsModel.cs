...
namespace BH.oM.Adapters.EnergyPlus.AdvancedConstructionSurfaceZoneConcepts
{
    ...
    public class SurfaceProperty_OtherSideConditionsModel : BHoMObject
    {
        ...
        public EmptyNoYes TypeOfModeling { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "GapConvectionRadiation");
    }
}