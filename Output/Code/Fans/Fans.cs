...
[JsonProperty(PropertyName="design_maximum_air_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> DesignMaximumAirFlowRate { get; set; } = null;
        

[JsonProperty(PropertyName="speed_control_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="electric_power_minimum_flow_rate_fraction")]
...
[JsonProperty(PropertyName="design_pressure_rise")]
...
[JsonProperty(PropertyName="motor_in_air_stream_fraction")]
...
[JsonProperty(PropertyName="design_electric_power_consumption", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> DesignElectricPowerConsumption { get; set; } = null;
        

[JsonProperty(PropertyName="design_power_sizing_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="electric_power_per_unit_flow_rate")]
public System.Nullable<float> ElectricPowerPerUnitFlowRate { get; set; } = null;
        

[JsonProperty(PropertyName="electric_power_per_unit_flow_rate_per_unit_pressure")]
...
[JsonProperty(PropertyName="electric_power_function_of_flow_fraction_curve_name")]
...
[JsonProperty(PropertyName="night_ventilation_mode_pressure_rise")]
...
[JsonProperty(PropertyName="night_ventilation_mode_flow_fraction")]
...
[JsonProperty(PropertyName="motor_loss_zone_name")]
...
[JsonProperty(PropertyName="motor_loss_radiative_fraction")]
...
[JsonProperty(PropertyName="speed_fractions")]
...
[JsonProperty(PropertyName="pressure_rise")]
public System.Nullable<float> PressureRise { get; set; } = null;
        

[JsonProperty(PropertyName="maximum_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
...
[Description("0.0 means fan motor outside of air stream, 1.0 means motor inside of air stream")]
[JsonProperty(PropertyName="motor_in_airstream_fraction")]
public System.Nullable<float> MotorInAirstreamFraction { get; set; } = (System.Nullable<float>)Single.Parse("1", CultureInfo.InvariantCulture);
...
[JsonProperty(PropertyName="fan_power_minimum_flow_rate_input_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="fan_power_minimum_flow_fraction")]
...
[JsonProperty(PropertyName="fan_power_minimum_air_flow_rate")]
...
[JsonProperty(PropertyName="fan_power_ratio_function_of_speed_ratio_curve_name")]
public string FanPowerRatioFunctionOfSpeedRatioCurveName { get; set; } = "";
        

[JsonProperty(PropertyName="fan_efficiency_ratio_function_of_speed_ratio_curve_name")]
...
[JsonProperty(PropertyName="flow_fraction_schedule_name")]
...
[Description("Control if fan is to be interlocked with HVAC system Availability Managers or not" +
    ".")]
[JsonProperty(PropertyName="system_availability_manager_coupling_mode", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("If field is used, the exhaust fan will not run if the zone temperature is lower t" +
    "han this limit")]
[JsonProperty(PropertyName="minimum_zone_temperature_limit_schedule_name")]
...
[JsonProperty(PropertyName="balanced_exhaust_fraction_schedule_name")]
...
[JsonProperty(PropertyName="minimum_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> MinimumFlowRate { get; set; } = null;
        

[Description("Applied to specified or autosized max fan airflow")]
[JsonProperty(PropertyName="fan_sizing_factor")]
...
[JsonProperty(PropertyName="fan_wheel_diameter")]
...
[JsonProperty(PropertyName="fan_outlet_area")]
...
[JsonProperty(PropertyName="maximum_fan_static_efficiency")]
...
[JsonProperty(PropertyName="euler_number_at_maximum_fan_static_efficiency")]
...
[JsonProperty(PropertyName="maximum_dimensionless_fan_airflow")]
...
[JsonProperty(PropertyName="motor_fan_pulley_ratio", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> MotorFanPulleyRatio { get; set; } = null;
        

[Description("Maximum torque transmitted by belt")]
[JsonProperty(PropertyName="belt_maximum_torque", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> BeltMaximumTorque { get; set; } = null;
        

[Description("Applied to specified or autosized max torque transmitted by belt")]
[JsonProperty(PropertyName="belt_sizing_factor")]
...
[JsonProperty(PropertyName="belt_fractional_torque_transition")]
...
[JsonProperty(PropertyName="motor_maximum_speed")]
public System.Nullable<float> MotorMaximumSpeed { get; set; } = null;
        

[Description("Maximum power input to drive belt by motor")]
[JsonProperty(PropertyName="maximum_motor_output_power", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> MaximumMotorOutputPower { get; set; } = null;
        

[Description("Applied to specified or autosized motor output power")]
[JsonProperty(PropertyName="motor_sizing_factor")]
...
[Description("Efficiency depends on fraction of full-load motor speed Efficiency depends on  fr" +
    ...
    "efficiency (0.97)")]
[JsonProperty(PropertyName="vfd_efficiency_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="maximum_vfd_output_power", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> MaximumVfdOutputPower { get; set; } = null;
        

[Description("Applied to specified or autosized VFD output power")]
[JsonProperty(PropertyName="vfd_sizing_factor")]
...
[JsonProperty(PropertyName="fan_pressure_rise_curve_name")]
...
[JsonProperty(PropertyName="duct_static_pressure_reset_curve_name")]
public string DuctStaticPressureResetCurveName { get; set; } = "";
        

[Description("xfan <= 0 Curve should have maximum of 1.0")]
[JsonProperty(PropertyName="normalized_fan_static_efficiency_curve_name_non_stall_region")]
public string NormalizedFanStaticEfficiencyCurveNameNonStallRegion { get; set; } = "";
        

[Description("xfan > 0 Curve should have maximum of 1.0")]
[JsonProperty(PropertyName="normalized_fan_static_efficiency_curve_name_stall_region")]
...
[JsonProperty(PropertyName="normalized_dimensionless_airflow_curve_name_non_stall_region")]
public string NormalizedDimensionlessAirflowCurveNameNonStallRegion { get; set; } = "";
        

[Description("xspd > 0 Curve should have maximum of 1.0")]
[JsonProperty(PropertyName="normalized_dimensionless_airflow_curve_name_stall_region")]
...
[JsonProperty(PropertyName="maximum_belt_efficiency_curve_name")]
...
[JsonProperty(PropertyName="normalized_belt_efficiency_curve_name_region_1")]
...
[JsonProperty(PropertyName="normalized_belt_efficiency_curve_name_region_2")]
...
[JsonProperty(PropertyName="normalized_belt_efficiency_curve_name_region_3")]
...
[JsonProperty(PropertyName="maximum_motor_efficiency_curve_name")]
public string MaximumMotorEfficiencyCurveName { get; set; } = "";
        

[Description("Curve should have minimum > 0.0 and maximum of 1.0 If field blank, assumes output" +
    " of curve is always 1.0")]
[JsonProperty(PropertyName="normalized_motor_efficiency_curve_name")]
...
[Description("Determines VFD efficiency as function of motor load or speed fraction Curve shoul" +
    ...
    "iciency (0.97)")]
[JsonProperty(PropertyName="vfd_efficiency_curve_name")]
