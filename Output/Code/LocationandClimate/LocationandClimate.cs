...
[JsonProperty(PropertyName="building_location_latitude_schedule")]
...
[JsonProperty(PropertyName="building_location_longitude_schedule")]
...
[JsonProperty(PropertyName="building_location_orientation_schedule")]
...
[JsonProperty(PropertyName="day_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="maximum_dry_bulb_temperature")]
...
[JsonProperty(PropertyName="daily_dry_bulb_temperature_range")]
...
[JsonProperty(PropertyName="dry_bulb_temperature_range_modifier_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="dry_bulb_temperature_range_modifier_day_schedule_name")]
...
[JsonProperty(PropertyName="humidity_condition_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("Wetbulb or dewpoint temperature coincident with the maximum temperature. Required" +
    ...
    "ltMultipliers\"")]
[JsonProperty(PropertyName="wetbulb_or_dewpoint_at_maximum_dry_bulb")]
...
[JsonProperty(PropertyName="humidity_condition_day_schedule_name")]
...
[Description("Humidity ratio coincident with the maximum temperature (constant humidity ratio t" +
    ...
    "\".")]
[JsonProperty(PropertyName="humidity_ratio_at_maximum_dry_bulb")]
...
[JsonProperty(PropertyName="enthalpy_at_maximum_dry_bulb")]
...
[JsonProperty(PropertyName="daily_wet_bulb_temperature_range")]
...
[Description("This field\'s value is also checked against the calculated \"standard barometric pr" +
    ...
    "tandard value.")]
[JsonProperty(PropertyName="barometric_pressure")]
...
[JsonProperty(PropertyName="rain_indicator", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="snow_indicator", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="daylight_saving_time_indicator", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
public EmptyNoYes DaylightSavingTimeIndicator { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "No");
        

[JsonProperty(PropertyName="solar_model_indicator", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="beam_solar_day_schedule_name")]
...
[JsonProperty(PropertyName="diffuse_solar_day_schedule_name")]
...
[JsonProperty(PropertyName="ashrae_clear_sky_optical_depth_for_beam_irradiance_taub_")]
...
[JsonProperty(PropertyName="ashrae_clear_sky_optical_depth_for_diffuse_irradiance_taud_")]
...
[JsonProperty(PropertyName="sky_clearness")]
...
[Description("If used this design day will be run with a custom limit on the maximum number of " +
    ...
    "e run time.")]
[JsonProperty(PropertyName="maximum_number_warmup_days")]
...
[JsonProperty(PropertyName="begin_environment_reset_mode", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="begin_month")]
public System.Nullable<float> BeginMonth { get; set; } = null;
        

[JsonProperty(PropertyName="begin_day_of_month")]
...
[JsonProperty(PropertyName="end_day_of_month")]
...
[JsonProperty(PropertyName="day_of_week_for_start_day", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="use_weather_file_daylight_saving_period", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
public EmptyNoYes UseWeatherFileDaylightSavingPeriod { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Yes");
        

[JsonProperty(PropertyName="use_weather_file_rain_and_snow_indicators", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("Following is a list of all possible types of Extreme and Typical periods that mig" +
    ...
    "ll weather files.")]
[JsonProperty(PropertyName="period_selection", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="begin_year")]
...
[JsonProperty(PropertyName="use_weather_file_holidays_and_special_days", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("if yes and single day holiday falls on weekend, \"holiday\" occurs on following Mon" +
    "day")]
[JsonProperty(PropertyName="apply_weekend_holiday_rule", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="use_weather_file_snow_indicators", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
public EmptyNoYes UseWeatherFileSnowIndicators { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "Yes");
        

[JsonProperty(PropertyName="treat_weather_as_actual", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="special_day_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="calculation_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="use_weather_file_horizontal_ir", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="wind_sensor_height_above_ground")]
...
[JsonProperty(PropertyName="wind_speed_profile_exponent")]
...
[JsonProperty(PropertyName="wind_speed_profile_boundary_layer_thickness")]
...
[JsonProperty(PropertyName="air_temperature_sensor_height_above_ground")]
...
[JsonProperty(PropertyName="air_temperature_gradient_coefficient")]
...
[JsonProperty(PropertyName="january_ground_temperature")]
...
[JsonProperty(PropertyName="february_ground_temperature")]
...
[JsonProperty(PropertyName="march_ground_temperature")]
...
[JsonProperty(PropertyName="april_ground_temperature")]
...
[JsonProperty(PropertyName="may_ground_temperature")]
...
[JsonProperty(PropertyName="june_ground_temperature")]
...
[JsonProperty(PropertyName="july_ground_temperature")]
...
[JsonProperty(PropertyName="august_ground_temperature")]
...
[JsonProperty(PropertyName="september_ground_temperature")]
...
[JsonProperty(PropertyName="october_ground_temperature")]
...
[JsonProperty(PropertyName="november_ground_temperature")]
...
[JsonProperty(PropertyName="december_ground_temperature")]
...
[JsonProperty(PropertyName="january_surface_ground_temperature")]
...
[JsonProperty(PropertyName="february_surface_ground_temperature")]
...
[JsonProperty(PropertyName="march_surface_ground_temperature")]
...
[JsonProperty(PropertyName="april_surface_ground_temperature")]
...
[JsonProperty(PropertyName="may_surface_ground_temperature")]
...
[JsonProperty(PropertyName="june_surface_ground_temperature")]
...
[JsonProperty(PropertyName="july_surface_ground_temperature")]
...
[JsonProperty(PropertyName="august_surface_ground_temperature")]
...
[JsonProperty(PropertyName="september_surface_ground_temperature")]
...
[JsonProperty(PropertyName="october_surface_ground_temperature")]
...
[JsonProperty(PropertyName="november_surface_ground_temperature")]
...
[JsonProperty(PropertyName="december_surface_ground_temperature")]
...
[JsonProperty(PropertyName="january_deep_ground_temperature")]
...
[JsonProperty(PropertyName="february_deep_ground_temperature")]
...
[JsonProperty(PropertyName="march_deep_ground_temperature")]
...
[JsonProperty(PropertyName="april_deep_ground_temperature")]
...
[JsonProperty(PropertyName="may_deep_ground_temperature")]
...
[JsonProperty(PropertyName="june_deep_ground_temperature")]
...
[JsonProperty(PropertyName="july_deep_ground_temperature")]
...
[JsonProperty(PropertyName="august_deep_ground_temperature")]
...
[JsonProperty(PropertyName="september_deep_ground_temperature")]
...
[JsonProperty(PropertyName="october_deep_ground_temperature")]
...
[JsonProperty(PropertyName="november_deep_ground_temperature")]
...
[JsonProperty(PropertyName="december_deep_ground_temperature")]
...
[JsonProperty(PropertyName="average_amplitude_of_surface_temperature")]
...
[JsonProperty(PropertyName="phase_shift_of_minimum_surface_temperature")]
...
[JsonProperty(PropertyName="average_soil_surface_tempeature")]
public System.Nullable<float> AverageSoilSurfaceTempeature { get; set; } = null;
        

[JsonProperty(PropertyName="soil_surface_temperature_amplitude_1")]
public System.Nullable<float> SoilSurfaceTemperatureAmplitude1 { get; set; } = null;
        

[JsonProperty(PropertyName="soil_surface_temperature_amplitude_2")]
public System.Nullable<float> SoilSurfaceTemperatureAmplitude2 { get; set; } = null;
        

[JsonProperty(PropertyName="phase_shift_of_temperature_amplitude_1")]
public System.Nullable<float> PhaseShiftOfTemperatureAmplitude1 { get; set; } = null;
        

[JsonProperty(PropertyName="phase_shift_of_temperature_amplitude_2")]
...
[JsonProperty(PropertyName="ground_domain_depth")]
...
[JsonProperty(PropertyName="perimeter_offset")]
...
[JsonProperty(PropertyName="slab_boundary_condition_model_name")]
...
[JsonProperty(PropertyName="slab_location", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="slab_material_name")]
...
[Description("This field specifies the presence of insulation beneath the slab. Only required f" +
    "or in-grade case.")]
[JsonProperty(PropertyName="horizontal_insulation", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="horizontal_insulation_material_name")]
...
[JsonProperty(PropertyName="horizontal_insulation_extents", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="perimeter_insulation_width")]
...
[JsonProperty(PropertyName="vertical_insulation", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="vertical_insulation_material_name")]
...
[JsonProperty(PropertyName="vertical_insulation_depth")]
...
[JsonProperty(PropertyName="geometric_mesh_coefficient")]
...
[JsonProperty(PropertyName="mesh_density_parameter")]
...
[JsonProperty(PropertyName="basement_floor_boundary_condition_model_name")]
...
[Description("Width of horizontal perimeter insulation measured from foundation wall inside sur" +
    "face.")]
[JsonProperty(PropertyName="perimeter_horizontal_insulation_width")]
...
[JsonProperty(PropertyName="basement_wall_depth")]
public System.Nullable<float> BasementWallDepth { get; set; } = null;
        

[JsonProperty(PropertyName="basement_wall_boundary_condition_model_name")]
...
[JsonProperty(PropertyName="basement_wall_vertical_insulation_material_name")]
...
[JsonProperty(PropertyName="january_ground_reflectance")]
...
[JsonProperty(PropertyName="february_ground_reflectance")]
...
[JsonProperty(PropertyName="march_ground_reflectance")]
...
[JsonProperty(PropertyName="april_ground_reflectance")]
...
[JsonProperty(PropertyName="may_ground_reflectance")]
...
[JsonProperty(PropertyName="june_ground_reflectance")]
...
[JsonProperty(PropertyName="july_ground_reflectance")]
...
[JsonProperty(PropertyName="august_ground_reflectance")]
...
[JsonProperty(PropertyName="september_ground_reflectance")]
...
[JsonProperty(PropertyName="october_ground_reflectance")]
...
[JsonProperty(PropertyName="november_ground_reflectance")]
...
[JsonProperty(PropertyName="december_ground_reflectance")]
...
[JsonProperty(PropertyName="ground_reflected_solar_modifier")]
...
[JsonProperty(PropertyName="daylighting_ground_reflected_solar_modifier")]
...
[JsonProperty(PropertyName="calculation_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="temperature_schedule_name")]
...
[Description("If calculation method is CorrelationFromWeatherFile or Schedule, this input field" +
    " is ignored.")]
[JsonProperty(PropertyName="annual_average_outdoor_air_temperature")]
public System.Nullable<float> AnnualAverageOutdoorAirTemperature { get; set; } = null;
        

[Description("If calculation method is CorrelationFromWeatherFile or Schedule, this input field" +
    " is ignored.")]
[JsonProperty(PropertyName="maximum_difference_in_monthly_average_outdoor_air_temperatures")]
...
[JsonProperty(PropertyName="precipitation_model_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="design_level_for_total_annual_precipitation")]
...
[JsonProperty(PropertyName="irrigation_model_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("Schedule values in meters of water per hour values should be non-negative")]
[JsonProperty(PropertyName="irrigation_rate_schedule_name")]
...
[Description("Used with SmartSchedule to set the saturation level at which no irrigation is all" +
    "owed.")]
[JsonProperty(PropertyName="irrigation_maximum_saturation_threshold")]
...
[JsonProperty(PropertyName="spectrum_data_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="solar_spectrum_data_object_name")]
public string SolarSpectrumDataObjectName { get; set; } = "";
        

[JsonProperty(PropertyName="visible_spectrum_data_object_name")]
...
[JsonProperty(PropertyName="spectrum_data_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="wavelength")]
public System.Nullable<float> Wavelength { get; set; } = null;
        

[JsonProperty(PropertyName="spectrum")]
...
[JsonProperty(PropertyName="spectrum_2")]
