...
[JsonProperty(PropertyName="outdoor_air_flow_per_person")]
...
[Description("This input is only used if the field Outdoor Air Method is Flow/Area, Sum, or Max" +
    "imum")]
[JsonProperty(PropertyName="outdoor_air_flow_per_zone_floor_area")]
...
[Description("This input is only used if the field Outdoor Air Method is Flow/Zone, Sum, or Max" +
    "imum")]
[JsonProperty(PropertyName="outdoor_air_flow_per_zone")]
...
[Description("This input is only used if the field Outdoor Air Method is AirChanges/Hour, Sum, " +
    "or Maximum")]
[JsonProperty(PropertyName="outdoor_air_flow_air_changes_per_hour")]
...
[JsonProperty(PropertyName="proportional_control_minimum_outdoor_air_flow_rate_schedule_name")]
...
[JsonProperty(PropertyName="zone_air_distribution_effectiveness_in_cooling_mode")]
...
[JsonProperty(PropertyName="zone_air_distribution_effectiveness_in_heating_mode")]
...
[Description("optionally used to replace Zone Air Distribution Effectiveness in Cooling and Hea" +
    "ting Mode")]
[JsonProperty(PropertyName="zone_air_distribution_effectiveness_schedule_name")]
public string ZoneAirDistributionEffectivenessScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="zone_secondary_recirculation_fraction")]
...
[JsonProperty(PropertyName="minimum_zone_ventilation_efficiency")]
...
[JsonProperty(PropertyName="heating_sizing_factor")]
...
[JsonProperty(PropertyName="cooling_sizing_factor")]
...
[Description("blank => set the timesteps in averaging window to Number of Timesteps per Hour re" +
    ...
    "veraging window")]
[JsonProperty(PropertyName="timesteps_in_averaging_window")]
...
[JsonProperty(PropertyName="zone_cooling_design_supply_air_humidity_ratio")]
public System.Nullable<float> ZoneCoolingDesignSupplyAirHumidityRatio { get; set; } = null;
        

[JsonProperty(PropertyName="zone_heating_design_supply_air_humidity_ratio")]
...
[JsonProperty(PropertyName="cooling_design_air_flow_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="cooling_design_air_flow_rate")]
...
[Description("default is .15 cfm/ft2 This input is used if Cooling Design Air Flow Method is De" +
    "signDayWithLimit")]
[JsonProperty(PropertyName="cooling_minimum_air_flow_per_zone_floor_area")]
...
[JsonProperty(PropertyName="cooling_minimum_air_flow")]
...
[JsonProperty(PropertyName="cooling_minimum_air_flow_fraction")]
...
[JsonProperty(PropertyName="heating_design_air_flow_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="heating_design_air_flow_rate")]
...
[JsonProperty(PropertyName="heating_maximum_air_flow_per_zone_floor_area")]
...
[JsonProperty(PropertyName="heating_maximum_air_flow")]
...
[JsonProperty(PropertyName="heating_maximum_air_flow_fraction")]
...
[Description("account for effect of dedicated outdoor air system supplying air directly to the " +
    "zone")]
[JsonProperty(PropertyName="account_for_dedicated_outdoor_air_system", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="dedicated_outdoor_air_system_control_strategy", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="dedicated_outdoor_air_low_setpoint_temperature_for_design", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> DedicatedOutdoorAirLowSetpointTemperatureForDesign { get; set; } = null;
        

[JsonProperty(PropertyName="dedicated_outdoor_air_high_setpoint_temperature_for_design", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> DedicatedOutdoorAirHighSetpointTemperatureForDesign { get; set; } = null;
    }
...
[JsonProperty(PropertyName="cooling_supply_air_flow_rate_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("Enter the cooling supply air volume flow rate per total conditioned floor area. R" +
    ...
    ".")]
[JsonProperty(PropertyName="cooling_supply_air_flow_rate_per_floor_area")]
...
[JsonProperty(PropertyName="cooling_fraction_of_autosized_cooling_supply_air_flow_rate")]
...
[JsonProperty(PropertyName="cooling_supply_air_flow_rate_per_unit_cooling_capacity")]
...
[JsonProperty(PropertyName="no_load_supply_air_flow_rate_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="no_load_supply_air_flow_rate_per_floor_area")]
...
[JsonProperty(PropertyName="no_load_fraction_of_cooling_supply_air_flow_rate")]
...
[JsonProperty(PropertyName="no_load_fraction_of_heating_supply_air_flow_rate")]
...
[JsonProperty(PropertyName="heating_supply_air_flow_rate_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("Enter the heating supply air volume flow rate per total conditioned floor area. R" +
    ...
    ".")]
[JsonProperty(PropertyName="heating_supply_air_flow_rate_per_floor_area")]
...
[JsonProperty(PropertyName="heating_fraction_of_heating_supply_air_flow_rate")]
...
[JsonProperty(PropertyName="heating_supply_air_flow_rate_per_unit_heating_capacity")]
...
[JsonProperty(PropertyName="cooling_design_capacity_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="cooling_design_capacity", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> CoolingDesignCapacity { get; set; } = null;
...
[JsonProperty(PropertyName="cooling_design_capacity_per_floor_area")]
...
[JsonProperty(PropertyName="fraction_of_autosized_cooling_design_capacity")]
...
[JsonProperty(PropertyName="heating_design_capacity_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="heating_design_capacity", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> HeatingDesignCapacity { get; set; } = null;
...
[JsonProperty(PropertyName="heating_design_capacity_per_floor_area")]
...
[Description("Enter the fraction of auto-sized heating design capacity. Required field when cap" +
    ...
    "city.")]
[JsonProperty(PropertyName="fraction_of_autosized_heating_design_capacity")]
...
[Description("The fraction of the design sensible cooling load to be met by this terminal unit." +
    ...
    ".")]
[JsonProperty(PropertyName="fraction_of_design_cooling_load")]
...
[JsonProperty(PropertyName="cooling_design_supply_air_temperature_difference_ratio")]
...
[Description("The fraction of the design sensible heating load to be met by this terminal unit." +
    ...
    ".")]
[JsonProperty(PropertyName="fraction_of_design_heating_load")]
...
[JsonProperty(PropertyName="heating_design_supply_air_temperature_difference_ratio")]
...
[Description("The fraction of the zone minimum outdoor air requirement to be met by this termin" +
    "al unit.")]
[JsonProperty(PropertyName="fraction_of_minimum_outdoor_air_flow")]
...
[JsonProperty(PropertyName="airloop_name")]
...
[JsonProperty(PropertyName="type_of_load_to_size_on", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="design_outdoor_air_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> DesignOutdoorAirFlowRate { get; set; } = null;
        

[JsonProperty(PropertyName="central_heating_maximum_system_air_flow_ratio", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> CentralHeatingMaximumSystemAirFlowRatio { get; set; } = null;
...
[JsonProperty(PropertyName="central_cooling_design_supply_air_temperature")]
public System.Nullable<float> CentralCoolingDesignSupplyAirTemperature { get; set; } = null;
        

[JsonProperty(PropertyName="central_heating_design_supply_air_temperature")]
public System.Nullable<float> CentralHeatingDesignSupplyAirTemperature { get; set; } = null;
        

[JsonProperty(PropertyName="type_of_zone_sum_to_use", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="100_outdoor_air_in_cooling", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
public EmptyNoYes _100OutdoorAirInCooling { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "No");
        

[JsonProperty(PropertyName="100_outdoor_air_in_heating", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
public EmptyNoYes _100OutdoorAirInHeating { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "No");
        

[JsonProperty(PropertyName="central_cooling_design_supply_air_humidity_ratio")]
...
[JsonProperty(PropertyName="central_heating_design_supply_air_humidity_ratio")]
...
[Description("This input is used if Cooling Supply Air Flow Rate Method is Flow/System This val" +
    ...
    "s.")]
[JsonProperty(PropertyName="cooling_supply_air_flow_rate")]
...
[Description("Required field when Heating Supply Air Flow Rate Method is Flow/System This value" +
    ...
    "")]
[JsonProperty(PropertyName="heating_supply_air_flow_rate")]
...
[Description("Enter the supply air volume flow rate as a fraction of the heating supply air flo" +
    ...
    "osizedHeatingAirflow.")]
[JsonProperty(PropertyName="heating_fraction_of_autosized_heating_supply_air_flow_rate")]
...
[Description("Enter the supply air volume flow rate as a fraction of the cooling supply air flo" +
    "w rate. Required field when Heating Supply Air Flow Rate Method is FractionOfAut" +
    "osizedCoolingAirflow.")]
[JsonProperty(PropertyName="heating_fraction_of_autosized_cooling_supply_air_flow_rate")]
...
[JsonProperty(PropertyName="central_cooling_capacity_control_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="plant_or_condenser_loop_name")]
public string PlantOrCondenserLoopName { get; set; } = "";
        

[JsonProperty(PropertyName="loop_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
public Sizing_Plant_LoopType LoopType { get; set; } = (Sizing_Plant_LoopType)Enum.Parse(typeof(Sizing_Plant_LoopType), "Condenser");
        

[JsonProperty(PropertyName="design_loop_exit_temperature")]
public System.Nullable<float> DesignLoopExitTemperature { get; set; } = null;
        

[JsonProperty(PropertyName="loop_design_temperature_difference")]
...
[JsonProperty(PropertyName="zone_timesteps_in_averaging_window")]
...
[Description("this is used to adjust the result for coincident sizing by applying a sizing fact" +
    "or")]
[JsonProperty(PropertyName="coincident_sizing_factor_mode", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
