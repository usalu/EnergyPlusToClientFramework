...
[JsonProperty(PropertyName="cooling_capacity_ratio_modifier_function_of_low_temperature_curve_name")]
...
[JsonProperty(PropertyName="cooling_capacity_ratio_boundary_curve_name")]
...
[JsonProperty(PropertyName="cooling_capacity_ratio_modifier_function_of_high_temperature_curve_name")]
...
[JsonProperty(PropertyName="cooling_energy_input_ratio_modifier_function_of_low_temperature_curve_name")]
...
[JsonProperty(PropertyName="cooling_energy_input_ratio_boundary_curve_name")]
...
[Description("This curve object is used to describe the high outdoor temperature performance cu" +
    ...
    " temperature")]
[JsonProperty(PropertyName="cooling_energy_input_ratio_modifier_function_of_high_temperature_curve_name")]
...
[JsonProperty(PropertyName="cooling_energy_input_ratio_modifier_function_of_low_part_load_ratio_curve_name")]
...
[JsonProperty(PropertyName="cooling_energy_input_ratio_modifier_function_of_high_part_load_ratio_curve_name")]
...
[JsonProperty(PropertyName="cooling_combination_ratio_correction_factor_curve_name")]
...
[JsonProperty(PropertyName="cooling_part_load_fraction_correlation_curve_name")]
...
[JsonProperty(PropertyName="heating_capacity_ratio_modifier_function_of_low_temperature_curve_name")]
...
[JsonProperty(PropertyName="heating_capacity_ratio_boundary_curve_name")]
...
[JsonProperty(PropertyName="heating_capacity_ratio_modifier_function_of_high_temperature_curve_name")]
...
[JsonProperty(PropertyName="heating_energy_input_ratio_modifier_function_of_low_temperature_curve_name")]
...
[JsonProperty(PropertyName="heating_energy_input_ratio_boundary_curve_name")]
...
[JsonProperty(PropertyName="heating_energy_input_ratio_modifier_function_of_high_temperature_curve_name")]
...
[JsonProperty(PropertyName="heating_performance_curve_outdoor_temperature_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("This curve represents the heating energy input ratio for part-load ratios less th" +
    "an 1.")]
[JsonProperty(PropertyName="heating_energy_input_ratio_modifier_function_of_low_part_load_ratio_curve_name")]
...
[Description("This curve represents the heating energy input ratio for part-load ratios greater" +
    " than 1.")]
[JsonProperty(PropertyName="heating_energy_input_ratio_modifier_function_of_high_part_load_ratio_curve_name")]
...
[JsonProperty(PropertyName="heating_combination_ratio_correction_factor_curve_name")]
...
[Description("This curve defines the cycling losses when the heat pump compressor cycles on and" +
    ...
    "d.")]
[JsonProperty(PropertyName="heating_part_load_fraction_correlation_curve_name")]
...
[Description("Enter the name of a ZoneTerminalUnitList. This list connects zone terminal units " +
    "to this heat pump.")]
[JsonProperty(PropertyName="zone_terminal_unit_list_name")]
...
[JsonProperty(PropertyName="piping_correction_factor_for_length_in_cooling_mode_curve_name")]
...
[JsonProperty(PropertyName="piping_correction_factor_for_height_in_cooling_mode_coefficient")]
...
[JsonProperty(PropertyName="piping_correction_factor_for_length_in_heating_mode_curve_name")]
...
[Description("PCF = a0 + a1*L + a2*L^2 + a3*L^3 + a4*H PCF = a0 + a1*L + a2*L^2 + a3*CR + a4*CR" +
    "^2 + a5*(L)(CR) + a6*H where L = length, H = height, and CR = combination ratio " +
    "specifies coefficient a4 (or a6 for biquadratic) in the PCF equation")]
[JsonProperty(PropertyName="piping_correction_factor_for_height_in_heating_mode_coefficient")]
...
[Description("A valid performance curve must be used if reversecycle defrost strategy is select" +
    "ed.")]
[JsonProperty(PropertyName="defrost_energy_input_ratio_modifier_function_of_temperature_curve_name")]
...
[Description("Enter the name of a performance curve which represents the change in cooling capa" +
    ...
    "t is blank")]
[JsonProperty(PropertyName="heat_recovery_cooling_capacity_modifier_curve_name")]
...
[Description("Enter the fractional capacity available at the start of heat recovery mode. The c" +
    ...
    "ime Constant")]
[JsonProperty(PropertyName="initial_heat_recovery_cooling_capacity_fraction")]
...
[Description("Enter the time constant used to model the transition from cooling only mode to he" +
    "at recovery mode")]
[JsonProperty(PropertyName="heat_recovery_cooling_capacity_time_constant")]
...
[Description("Enter the name of a performance curve which represents the change in cooling ener" +
    ...
    "is blank")]
[JsonProperty(PropertyName="heat_recovery_cooling_energy_modifier_curve_name")]
...
[JsonProperty(PropertyName="initial_heat_recovery_cooling_energy_fraction")]
...
[Description("Enter the time constant used to model the transition from cooling only mode to he" +
    "at recovery mode")]
[JsonProperty(PropertyName="heat_recovery_cooling_energy_time_constant")]
...
[Description("Enter the name of a performance curve which represents the change in heating capa" +
    ...
    "t is blank")]
[JsonProperty(PropertyName="heat_recovery_heating_capacity_modifier_curve_name")]
...
[Description("Enter the fractional capacity available at the start of heat recovery mode. The c" +
    ...
    "ime Constant")]
[JsonProperty(PropertyName="initial_heat_recovery_heating_capacity_fraction")]
...
[Description("Enter the time constant used to model the transition from cooling only mode to he" +
    "at recovery mode")]
[JsonProperty(PropertyName="heat_recovery_heating_capacity_time_constant")]
...
[JsonProperty(PropertyName="heat_recovery_heating_energy_modifier_curve_name")]
public string HeatRecoveryHeatingEnergyModifierCurveName { get; set; } = "";
        

[Description(@"Enter the fractional electric consumption rate at the start of heat recovery mode. The electric consumption rate exponentially approaches the steady-state value according to the inputs for Heat Recovery Cooling Energy Modifier and Heat Recovery Cooling Energy Time Constant")]
[JsonProperty(PropertyName="initial_heat_recovery_heating_energy_fraction")]
...
[Description("Enter the time constant used to model the transition from cooling only mode to he" +
    "at recovery mode")]
[JsonProperty(PropertyName="heat_recovery_heating_energy_time_constant")]
...
[JsonProperty(PropertyName="heat_pump_name")]
...
[JsonProperty(PropertyName="rated_evaporative_capacity", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> RatedEvaporativeCapacity { get; set; } = null;
...
[JsonProperty(PropertyName="rated_compressor_power_per_unit_of_rated_evaporative_capacity")]
...
[JsonProperty(PropertyName="minimum_outdoor_air_temperature_in_cooling_mode")]
...
[JsonProperty(PropertyName="maximum_outdoor_air_temperature_in_cooling_mode")]
...
[Description("Enter the minimum outdoor temperature allowed for heating operation Heating is di" +
    "sabled below this temperature")]
[JsonProperty(PropertyName="minimum_outdoor_air_temperature_in_heating_mode")]
...
[Description("Enter the maximum outdoor temperature allowed for heating operation Heating is di" +
    "sabled below this temperature")]
[JsonProperty(PropertyName="maximum_outdoor_air_temperature_in_heating_mode")]
...
[JsonProperty(PropertyName="reference_outdoor_unit_superheating")]
...
[JsonProperty(PropertyName="reference_outdoor_unit_subcooling")]
...
[JsonProperty(PropertyName="refrigerant_temperature_control_algorithm_for_indoor_unit", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="reference_evaporating_temperature_for_indoor_unit")]
...
[JsonProperty(PropertyName="reference_condensing_temperature_for_indoor_unit")]
...
[Description("This field is used if Refrigerant Temperature Control Algorithm is VariableTemp E" +
    "vaporating temperature is the refrigerant temperature, not air temperature")]
[JsonProperty(PropertyName="variable_evaporating_temperature_minimum_for_indoor_unit")]
...
[Description("This field is used if Refrigerant Temperature Control Algorithm is VariableTemp E" +
    "vaporating temperature is the refrigerant temperature, not air temperature")]
[JsonProperty(PropertyName="variable_evaporating_temperature_maximum_for_indoor_unit")]
...
[Description("This field is used if Refrigerant Temperature Control Algorithm is VariableTemp C" +
    "ondensing temperature is the refrigerant temperature, not air temperature")]
[JsonProperty(PropertyName="variable_condensing_temperature_minimum_for_indoor_unit")]
...
[Description("This field is used if Refrigerant Temperature Control Algorithm is VariableTemp C" +
    "ondensing temperature is the refrigerant temperature, not air temperature")]
[JsonProperty(PropertyName="variable_condensing_temperature_maximum_for_indoor_unit")]
...
[JsonProperty(PropertyName="outdoor_unit_fan_power_per_unit_of_rated_evaporative_capacity")]
...
[JsonProperty(PropertyName="outdoor_unit_fan_flow_rate_per_unit_of_rated_evaporative_capacity")]
...
[JsonProperty(PropertyName="outdoor_unit_evaporating_temperature_function_of_superheating_curve_name")]
public string OutdoorUnitEvaporatingTemperatureFunctionOfSuperheatingCurveName { get; set; } = "";
        

[JsonProperty(PropertyName="outdoor_unit_condensing_temperature_function_of_subcooling_curve_name")]
...
[JsonProperty(PropertyName="diameter_of_main_pipe_connecting_outdoor_unit_to_the_first_branch_joint")]
...
[JsonProperty(PropertyName="length_of_main_pipe_connecting_outdoor_unit_to_the_first_branch_joint")]
...
[JsonProperty(PropertyName="equivalent_length_of_main_pipe_connecting_outdoor_unit_to_the_first_branch_joint")]
...
[Description("Difference between outdoor unit height and indoor unit height Positive means outd" +
    ...
    "door unit")]
[JsonProperty(PropertyName="height_difference_between_outdoor_unit_and_indoor_units")]
...
[JsonProperty(PropertyName="main_pipe_insulation_thickness")]
...
[JsonProperty(PropertyName="main_pipe_insulation_thermal_conductivity")]
...
[JsonProperty(PropertyName="compressor_maximum_delta_pressure")]
...
[Description("First index represents minimal capacity operation Last index represents full capa" +
    "city operation")]
[JsonProperty(PropertyName="number_of_compressor_loading_index_entries")]
...
[JsonProperty(PropertyName="loading_indices")]
...
[Description("Enter the minimum outdoor temperature allowed for cooling operation Cooling is di" +
    "sabled below this temperature")]
[JsonProperty(PropertyName="minimum_outdoor_air_temperature_in_cooling_only_mode")]
...
[Description("Enter the maximum outdoor temperature allowed for cooling operation Cooling is di" +
    "sabled above this temperature")]
[JsonProperty(PropertyName="maximum_outdoor_air_temperature_in_cooling_only_mode")]
...
[Description("Enter the minimum outdoor temperature allowed for heating operation Heating is di" +
    "sabled below this temperature")]
[JsonProperty(PropertyName="minimum_outdoor_air_temperature_in_heating_only_mode")]
...
[Description("Enter the maximum outdoor temperature allowed for heating operation Heating is di" +
    "sabled below this temperature")]
[JsonProperty(PropertyName="maximum_outdoor_air_temperature_in_heating_only_mode")]
...
[JsonProperty(PropertyName="outdoor_unit_evaporator_reference_superheating")]
...
[JsonProperty(PropertyName="outdoor_unit_condenser_reference_subcooling")]
...
[JsonProperty(PropertyName="outdoor_unit_evaporator_rated_bypass_factor")]
...
[JsonProperty(PropertyName="outdoor_unit_condenser_rated_bypass_factor")]
...
[Description("Enter the rated capacity ratio between the main and supplementary outdoor unit he" +
    "at exchangers [W/W]")]
[JsonProperty(PropertyName="outdoor_unit_heat_exchanger_capacity_ratio")]
...
[Description("used to calculate the piping loss")]
[JsonProperty(PropertyName="diameter_of_main_pipe_for_suction_gas")]
...
[Description("used to calculate the piping loss")]
[JsonProperty(PropertyName="diameter_of_main_pipe_for_discharge_gas")]
...
[JsonProperty(PropertyName="compressor_inverter_efficiency")]
...
[JsonProperty(PropertyName="compressor_evaporative_capacity_correction_factor")]
...
[JsonProperty(PropertyName="terminal_units")]
