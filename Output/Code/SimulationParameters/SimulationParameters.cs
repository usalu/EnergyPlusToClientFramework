...
[JsonProperty(PropertyName="version_identifier")]
...
[Description("If Yes, Zone sizing is accomplished from corresponding Sizing:Zone objects and au" +
    "tosize fields.")]
[JsonProperty(PropertyName="do_zone_sizing_calculation", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="do_system_sizing_calculation", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("If Yes, Plant sizing is accomplished from corresponding Sizing:Plant objects and " +
    "autosize fields.")]
[JsonProperty(PropertyName="do_plant_sizing_calculation", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("If Yes, SizingPeriod:* objects are executed and results from those may be display" +
    "ed..")]
[JsonProperty(PropertyName="run_simulation_for_sizing_periods", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("If Yes, RunPeriod:* objects are executed and results from those may be displayed." +
    ".")]
[JsonProperty(PropertyName="run_simulation_for_weather_file_run_periods", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("If Yes, SizingPeriod:* objects are exectuted additional times for advanced sizing" +
    ...
    "")]
[JsonProperty(PropertyName="do_hvac_sizing_simulation_for_sizing_periods", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("the entire set of SizingPeriod:* objects may be repeated to fine tune size result" +
    ...
    " repeate the set")]
[JsonProperty(PropertyName="maximum_number_of_hvac_sizing_simulation_passes")]
...
[JsonProperty(PropertyName="use_coil_direct_solutions", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="zone_radiant_exchange_algorithm", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("The increasing mode number roughly correspond with increased speed. A description" +
    ...
    "ield value is used.")]
[JsonProperty(PropertyName="override_mode", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="maxzonetempdiff")]
...
[JsonProperty(PropertyName="maxalloweddeltemp")]
...
[JsonProperty(PropertyName="north_axis")]
...
[JsonProperty(PropertyName="terrain", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("Loads Convergence Tolerance Value is a change in load from one warmup day to the " +
    "next")]
[JsonProperty(PropertyName="loads_convergence_tolerance_value")]
...
[JsonProperty(PropertyName="temperature_convergence_tolerance_value")]
...
[JsonProperty(PropertyName="solar_distribution", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="maximum_number_of_warmup_days")]
...
[JsonProperty(PropertyName="minimum_number_of_warmup_days")]
...
[JsonProperty(PropertyName="shading_calculation_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="shading_calculation_update_frequency_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="shading_calculation_update_frequency")]
...
[JsonProperty(PropertyName="maximum_figures_in_shadow_overlap_calculations")]
...
[JsonProperty(PropertyName="polygon_clipping_algorithm", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="pixel_counting_resolution")]
...
[Description("Advanced Feature. Internal default is SimpleSkyDiffuseModeling If you have shadin" +
    ...
    "e information")]
[JsonProperty(PropertyName="sky_diffuse_modeling_algorithm", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="output_external_shading_calculation_results", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="disable_self_shading_within_shading_zone_groups", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="disable_self_shading_from_shading_zone_groups_to_other_zones", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
public EmptyNoYes DisableSelfShadingFromShadingZoneGroupsToOtherZones { get; set; } = (EmptyNoYes)Enum.Parse(typeof(EmptyNoYes), "No");
        

[JsonProperty(PropertyName="shading_zone_groups")]
...
[JsonProperty(PropertyName="surface_temperature_upper_limit")]
...
[JsonProperty(PropertyName="minimum_surface_convection_heat_transfer_coefficient_value")]
...
[JsonProperty(PropertyName="maximum_surface_convection_heat_transfer_coefficient_value")]
...
[JsonProperty(PropertyName="difference_scheme", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="space_discretization_constant")]
...
[JsonProperty(PropertyName="relaxation_factor")]
public System.Nullable<float> RelaxationFactor { get; set; } = (System.Nullable<float>)Single.Parse("1", CultureInfo.InvariantCulture);
        

[JsonProperty(PropertyName="inside_face_surface_temperature_convergence_criteria")]
...
[JsonProperty(PropertyName="carbon_dioxide_concentration", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="outdoor_carbon_dioxide_schedule_name")]
...
[JsonProperty(PropertyName="generic_contaminant_concentration", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("Schedule values should be generic contaminant concentration in parts per million " +
    "(ppm)")]
[JsonProperty(PropertyName="outdoor_generic_contaminant_schedule_name")]
...
[JsonProperty(PropertyName="adjust_zone_mixing_and_return_for_air_mass_flow_balance", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="infiltration_balancing_method", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="infiltration_balancing_zones", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="temperature_capacity_multiplier")]
...
[Description("Used to alter the capacitance of zone air with respect to moisture or humidity ra" +
    "tio")]
[JsonProperty(PropertyName="humidity_capacity_multiplier")]
...
[Description("Used to alter the capacitance of zone air with respect to zone air carbon dioxide" +
    " concentration")]
[JsonProperty(PropertyName="carbon_dioxide_capacity_multiplier")]
...
[Description("Used to alter the capacitance of zone air with respect to zone air generic contam" +
    "inant concentration")]
[JsonProperty(PropertyName="generic_contaminant_capacity_multiplier")]
...
[JsonProperty(PropertyName="number_of_timesteps_per_hour")]
...
[Description("0 sets the minimum to the zone timestep (ref: Timestep) 1 is normal (ratchet down" +
    ...
    "et to zone timestep")]
[JsonProperty(PropertyName="minimum_system_timestep")]
public System.Nullable<float> MinimumSystemTimestep { get; set; } = null;
        

[JsonProperty(PropertyName="maximum_hvac_iterations")]
...
[JsonProperty(PropertyName="minimum_plant_iterations")]
...
[JsonProperty(PropertyName="maximum_plant_iterations")]
...
[JsonProperty(PropertyName="number_of_iterations_before_algorithm_switch")]
