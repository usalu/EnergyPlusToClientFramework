...
[JsonProperty(PropertyName="fraction_of_radiant_energy_incident_on_people")]
...
[JsonProperty(PropertyName="design_object")]
...
[JsonProperty(PropertyName="rated_average_water_temperature")]
...
[JsonProperty(PropertyName="rated_water_mass_flow_rate")]
...
[JsonProperty(PropertyName="surface_fractions")]
...
[JsonProperty(PropertyName="rated_inlet_space_temperature")]
...
[JsonProperty(PropertyName="maximum_chilled_water_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> MaximumChilledWaterFlowRate { get; set; } = null;
...
[JsonProperty(PropertyName="cooling_control_throttling_range")]
...
[JsonProperty(PropertyName="cooling_control_temperature_schedule_name")]
public string CoolingControlTemperatureScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="condensation_control_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="condensation_control_dewpoint_offset")]
...
[Description("Identifies surfaces that radiant system is embedded in. For a system with multipl" +
    ...
    "ct.")]
[JsonProperty(PropertyName="surface_name_or_radiant_surface_group_name")]
public string SurfaceNameOrRadiantSurfaceGroupName { get; set; } = "";
        

[Description("(total length of pipe embedded in surface)")]
[JsonProperty(PropertyName="hydronic_tubing_length", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> HydronicTubingLength { get; set; } = null;
...
[JsonProperty(PropertyName="maximum_hot_water_flow", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> MaximumHotWaterFlow { get; set; } = null;
        

[JsonProperty(PropertyName="heating_water_inlet_node_name")]
public string HeatingWaterInletNodeName { get; set; } = "";
        

[JsonProperty(PropertyName="heating_water_outlet_node_name")]
...
[JsonProperty(PropertyName="maximum_cold_water_flow", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> MaximumColdWaterFlow { get; set; } = null;
...
[JsonProperty(PropertyName="number_of_circuits", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="circuit_length")]
...
[JsonProperty(PropertyName="fluid_to_radiant_surface_heat_transfer_model", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="hydronic_tubing_conductivity")]
...
[Description("(Temperature on which unit is controlled)")]
[JsonProperty(PropertyName="temperature_control_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="setpoint_control_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="heating_control_throttling_range")]
...
[JsonProperty(PropertyName="heating_control_temperature_schedule_name")]
...
[JsonProperty(PropertyName="changeover_delay_time_period_schedule")]
...
[JsonProperty(PropertyName="rated_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> RatedFlowRate { get; set; } = null;
...
[JsonProperty(PropertyName="rated_pump_head")]
...
[JsonProperty(PropertyName="heating_high_water_temperature_schedule_name")]
public string HeatingHighWaterTemperatureScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="heating_low_water_temperature_schedule_name")]
public string HeatingLowWaterTemperatureScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="heating_high_control_temperature_schedule_name")]
public string HeatingHighControlTemperatureScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="heating_low_control_temperature_schedule_name")]
...
[JsonProperty(PropertyName="cooling_high_water_temperature_schedule_name")]
public string CoolingHighWaterTemperatureScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="cooling_low_water_temperature_schedule_name")]
public string CoolingLowWaterTemperatureScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="cooling_high_control_temperature_schedule_name")]
public string CoolingHighControlTemperatureScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="cooling_low_control_temperature_schedule_name")]
...
[JsonProperty(PropertyName="running_mean_outdoor_dry_bulb_temperature_weighting_factor")]
...
[JsonProperty(PropertyName="heating_throttling_range")]
...
[JsonProperty(PropertyName="combustion_efficiency")]
...
[Description("Radiant+latent+lost fractions must sum to 1 or less, remainder is considered conv" +
    "ective heat")]
[JsonProperty(PropertyName="fraction_of_input_converted_to_radiant_energy")]
...
[JsonProperty(PropertyName="fraction_of_input_converted_to_latent_energy")]
...
[JsonProperty(PropertyName="fraction_of_input_that_is_lost")]
...
[JsonProperty(PropertyName="hollow_core_inside_diameter")]
...
[JsonProperty(PropertyName="heating_high_air_temperature_schedule_name")]
public string HeatingHighAirTemperatureScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="heating_low_air_temperature_schedule_name")]
...
[JsonProperty(PropertyName="cooling_high_air_temperature_schedule_name")]
public string CoolingHighAirTemperatureScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="cooling_low_air_temperature_schedule_name")]
...
[JsonProperty(PropertyName="slab_in_node_name")]
...
[JsonProperty(PropertyName="relief_air_node_name")]
...
[Description("This is the node name leaving the outdoor air mixer and entering the fan and coil" +
    "(s).")]
[JsonProperty(PropertyName="outdoor_air_mixer_outlet_node_name")]
public string OutdoorAirMixerOutletNodeName { get; set; } = "";
        

[Description("This is the node name of the fan outlet.")]
[JsonProperty(PropertyName="fan_outlet_node_name")]
...
[JsonProperty(PropertyName="coil_option_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="hot_water_or_steam_inlet_node_name")]
...
[JsonProperty(PropertyName="cold_water_inlet_node_name")]
