...
[Description("Use measured zone air temperature to calculate zone internal thermal mass. If set" +
    ...
    "ctivated.")]
[JsonProperty(PropertyName="calculate_zone_internal_thermal_mass", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="calculate_zone_air_infiltration_rate", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="calculate_zone_people_count", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="zone_measured_air_temperature_schedule_name")]
public string ZoneMeasuredAirTemperatureScheduleName { get; set; } = "";
        

[Description("from Schedule:File")]
[JsonProperty(PropertyName="zone_measured_air_humidity_ratio_schedule_name")]
public string ZoneMeasuredAirHumidityRatioScheduleName { get; set; } = "";
        

[Description("from Schedule:File")]
[JsonProperty(PropertyName="zone_measured_air_co2_concentration_schedule_name")]
...
[JsonProperty(PropertyName="zone_input_people_activity_schedule_name")]
...
[JsonProperty(PropertyName="zone_input_people_sensible_heat_fraction_schedule_name")]
...
[Description("When this field is provided and valid, the default radiant heat portion of the se" +
    ...
    "om Schedule:File")]
[JsonProperty(PropertyName="zone_input_people_radiant_heat_fraction_schedule_name")]
...
[JsonProperty(PropertyName="zone_input_people_co2_generation_rate_schedule_name")]
public string ZoneInputPeopleCo2GenerationRateScheduleName { get; set; } = "";
        

[Description("from Schedule:File")]
[JsonProperty(PropertyName="zone_input_supply_air_temperature_schedule_name")]
public string ZoneInputSupplyAirTemperatureScheduleName { get; set; } = "";
        

[Description("from Schedule:File")]
[JsonProperty(PropertyName="zone_input_supply_air_mass_flow_rate_schedule_name")]
public string ZoneInputSupplyAirMassFlowRateScheduleName { get; set; } = "";
        

[Description("from Schedule:File")]
[JsonProperty(PropertyName="zone_input_supply_air_humidity_ratio_schedule_name")]
public string ZoneInputSupplyAirHumidityRatioScheduleName { get; set; } = "";
        

[Description("from Schedule:File")]
[JsonProperty(PropertyName="zone_input_supply_air_co2_concentration_schedule_name")]
