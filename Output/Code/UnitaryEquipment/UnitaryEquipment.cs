...
[Description("Used to adjust heat pump heating capacity with respect to DX cooling capacity use" +
    ...
    "sed).")]
[JsonProperty(PropertyName="dx_heating_coil_sizing_ratio")]
...
[JsonProperty(PropertyName="use_doas_dx_cooling_coil", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="minimum_supply_air_temperature", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> MinimumSupplyAirTemperature { get; set; } = null;
...
[JsonProperty(PropertyName="latent_load_control", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="cooling_supply_air_flow_rate_per_unit_of_capacity")]
...
[JsonProperty(PropertyName="heating_supply_air_flow_rate_per_unit_of_capacity")]
...
[Description("Enter the supply air volume flow rate as a fraction of the cooling supply air flo" +
    ...
    "osizedCoolingValue.")]
[JsonProperty(PropertyName="no_load_fraction_of_autosized_cooling_supply_air_flow_rate")]
...
[Description("Enter the supply air volume flow rate as a fraction of the heating supply air flo" +
    "w rate. Required field when No Load Supply Air Flow Rate Method is FractionOfAut" +
    "osizedHeatingValue.")]
[JsonProperty(PropertyName="no_load_fraction_of_autosized_heating_supply_air_flow_rate")]
...
[JsonProperty(PropertyName="no_load_supply_air_flow_rate_per_unit_of_capacity_during_cooling_operation")]
...
[JsonProperty(PropertyName="no_load_supply_air_flow_rate_per_unit_of_capacity_during_heating_operation")]
...
[Description("Enter the maximum supply air temperature leaving the heating coil. When Control T" +
    ...
    "ed.")]
[JsonProperty(PropertyName="maximum_supply_air_temperature", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> MaximumSupplyAirTemperature { get; set; } = null;
...
[JsonProperty(PropertyName="ancillary_on_cycle_electric_power")]
...
[JsonProperty(PropertyName="ancillary_off_cycle_electric_power")]
...
[JsonProperty(PropertyName="maximum_temperature_for_heat_recovery")]
...
[Description("Enter the type of performance specification object used to describe the multispee" +
    "d coil.")]
[JsonProperty(PropertyName="design_specification_multispeed_object_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[Description("Enter the name of the performance specification object used to describe the multi" +
    "speed coil.")]
[JsonProperty(PropertyName="design_specification_multispeed_object_name")]
...
[Description("Used only for Multi speed coils Enter the number of the following sets of data fo" +
    "r air flow rates.")]
[JsonProperty(PropertyName="number_of_speeds_for_heating")]
...
[JsonProperty(PropertyName="single_mode_operation", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="no_load_supply_air_flow_rate_ratio")]
...
[JsonProperty(PropertyName="flow_ratios")]
...
[JsonProperty(PropertyName="furnace_air_inlet_node_name")]
public string FurnaceAirInletNodeName { get; set; } = "";
        

[JsonProperty(PropertyName="furnace_air_outlet_node_name")]
...
[JsonProperty(PropertyName="unitary_system_air_inlet_node_name")]
public string UnitarySystemAirInletNodeName { get; set; } = "";
        

[JsonProperty(PropertyName="unitary_system_air_outlet_node_name")]
...
[JsonProperty(PropertyName="heating_convergence")]
...
[JsonProperty(PropertyName="cooling_convergence")]
...
[JsonProperty(PropertyName="outdoor_air_flow_rate_multiplier_schedule_name")]
...
[JsonProperty(PropertyName="bypass_duct_mixer_node_name")]
...
[JsonProperty(PropertyName="bypass_duct_splitter_node_name")]
...
[JsonProperty(PropertyName="priority_control_mode", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="minimum_outlet_air_temperature_during_cooling_operation")]
...
[JsonProperty(PropertyName="maximum_outlet_air_temperature_during_heating_operation")]
...
[Description("Enter the name of the bypass duct node connected to a plenum or mixer. This field" +
    ...
    "d.")]
[JsonProperty(PropertyName="plenum_or_mixer_inlet_node_name")]
...
[JsonProperty(PropertyName="minimum_runtime_before_operating_mode_change")]
...
[JsonProperty(PropertyName="auxiliary_on_cycle_electric_power")]
...
[JsonProperty(PropertyName="auxiliary_off_cycle_electric_power")]
...
[Description("Enter the operating supply air flow rate during heating operation or specify auto" +
    "size.")]
[JsonProperty(PropertyName="heating_speed_1_supply_air_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> HeatingSpeed1SupplyAirFlowRate { get; set; } = null;
        

[Description("Enter the operating supply air flow rate during heating operation or specify auto" +
    "size.")]
[JsonProperty(PropertyName="heating_speed_2_supply_air_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> HeatingSpeed2SupplyAirFlowRate { get; set; } = null;
        

[Description("Enter the operating supply air flow rate during heating operation or specify auto" +
    "size.")]
[JsonProperty(PropertyName="heating_speed_3_supply_air_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> HeatingSpeed3SupplyAirFlowRate { get; set; } = null;
        

[Description("Enter the operating supply air flow rate during heating operation or specify auto" +
    "size.")]
[JsonProperty(PropertyName="heating_speed_4_supply_air_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> HeatingSpeed4SupplyAirFlowRate { get; set; } = null;
        

[Description("Enter the operating supply air flow rate during cooling operation or specify auto" +
    "size.")]
[JsonProperty(PropertyName="cooling_speed_1_supply_air_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> CoolingSpeed1SupplyAirFlowRate { get; set; } = null;
        

[Description("Enter the operating supply air flow rate during cooling operation or specify auto" +
    "size.")]
[JsonProperty(PropertyName="cooling_speed_2_supply_air_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> CoolingSpeed2SupplyAirFlowRate { get; set; } = null;
        

[Description("Enter the operating supply air flow rate during cooling operation or specify auto" +
    "size.")]
[JsonProperty(PropertyName="cooling_speed_3_supply_air_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> CoolingSpeed3SupplyAirFlowRate { get; set; } = null;
        

[Description("Enter the operating supply air flow rate during cooling operation or specify auto" +
    "size.")]
[JsonProperty(PropertyName="cooling_speed_4_supply_air_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> CoolingSpeed4SupplyAirFlowRate { get; set; } = null;
    }
