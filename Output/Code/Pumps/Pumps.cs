...
[JsonProperty(PropertyName="design_maximum_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> DesignMaximumFlowRate { get; set; } = null;
        

[Description("default head is 60 feet")]
[JsonProperty(PropertyName="design_pump_head")]
...
[Description("When autosized the type of scaling factor is chosen in the input field Design Pow" +
    "er Sizing Method")]
[JsonProperty(PropertyName="design_power_consumption", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> DesignPowerConsumption { get; set; } = null;
...
[JsonProperty(PropertyName="coefficient_1_of_the_part_load_performance_curve")]
...
[JsonProperty(PropertyName="coefficient_2_of_the_part_load_performance_curve")]
...
[JsonProperty(PropertyName="coefficient_3_of_the_part_load_performance_curve")]
...
[JsonProperty(PropertyName="coefficient_4_of_the_part_load_performance_curve")]
...
[Description("When autosized the scaling factor is the input field Design Minimum Flow Rate Fra" +
    "ction")]
[JsonProperty(PropertyName="design_minimum_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> DesignMinimumFlowRate { get; set; } = null;
...
[JsonProperty(PropertyName="pump_curve_name")]
public string PumpCurveName { get; set; } = "";
        

[Description("\"D\" in above expression in field A6")]
[JsonProperty(PropertyName="impeller_diameter")]
public System.Nullable<float> ImpellerDiameter { get; set; } = null;
        

[JsonProperty(PropertyName="vfd_control_type", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="pump_rpm_schedule_name")]
public string PumpRpmScheduleName { get; set; } = "";
        

[JsonProperty(PropertyName="minimum_pressure_schedule")]
public string MinimumPressureSchedule { get; set; } = "";
        

[JsonProperty(PropertyName="maximum_pressure_schedule")]
public string MaximumPressureSchedule { get; set; } = "";
        

[JsonProperty(PropertyName="minimum_rpm_schedule")]
public string MinimumRpmSchedule { get; set; } = "";
        

[JsonProperty(PropertyName="maximum_rpm_schedule")]
...
[JsonProperty(PropertyName="design_electric_power_per_unit_flow_rate")]
...
[Description("Used to size Design Power Consumption from design flow rate for head and motor ef" +
    "ficiency")]
[JsonProperty(PropertyName="design_shaft_power_per_unit_flow_rate_per_unit_head")]
...
[JsonProperty(PropertyName="design_minimum_flow_rate_fraction")]
...
[JsonProperty(PropertyName="rotational_speed")]
...
[JsonProperty(PropertyName="design_steam_volume_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> DesignSteamVolumeFlowRate { get; set; } = null;
...
[JsonProperty(PropertyName="total_design_flow_rate", ItemConverterType=typeof(EnergyPlus_oM.EPNullToAutosizeJsonConverter))]
public System.Nullable<float> TotalDesignFlowRate { get; set; } = null;
        

[JsonProperty(PropertyName="number_of_pumps_in_bank")]
public System.Nullable<float> NumberOfPumpsInBank { get; set; } = null;
        

[JsonProperty(PropertyName="flow_sequencing_control_scheme", ItemConverterType=typeof(Newtonsoft.Json.Converters.StringEnumConverter))]
...
[JsonProperty(PropertyName="minimum_flow_rate_fraction")]
